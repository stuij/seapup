...
(defparameter *bot-scanner* (create-scanner "google|msnbot|wget|curl|baiduspider|bingbot|rambler|yahoo|AbachoBOT|accoona|AcioRobot|ASPSeek|Dumbot|GeonaBot|Gigabot|Lycos|MSRBOT|Scooter|AltaVista|IDBot|eStyle|Scrubby|ia_archiver|Sogou web spider|Twitterbot|MJ12bot|facebookexternalhit|Tweetmeme|SurveyBot|linkdexbot"
